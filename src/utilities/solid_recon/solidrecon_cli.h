...
namespace jana {
  ...
  /// List all the available plugins at @env_var $JANA_PLUGIN_PATH and @env_var $solid_recon_MY/plugins.
  ...
  /// Add the default plugins and the plugins at $solid_recon_MY/plugins to @param options.params.
