...
#include "algorithms/digi/GEMTrackerDigiConfig.h"

namespace eicrecon {

void GEMTrackerDigi::init() {
...
void GEMTrackerDigi::process(
        const GEMTrackerDigi::Input& input,
        const GEMTrackerDigi::Output& output) const {
