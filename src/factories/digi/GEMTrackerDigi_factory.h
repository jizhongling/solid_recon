...
#include "algorithms/digi/GEMTrackerDigi.h"
...
class GEMTrackerDigi_factory : public JOmniFactory<GEMTrackerDigi_factory, GEMTrackerDigiConfig> {

public:
    using AlgoT = eicrecon::GEMTrackerDigi;
private:
