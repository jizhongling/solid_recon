...
JEventProcessorPODIO::JEventProcessorPODIO() {
    ...
    std::vector<std::string> output_collections={
      ...
      "LAEC_ShTruthClusterAssociations",
      "LAEC_ShClusters",
      "LAEC_ShClusterAssociations",
      "LAEC_ShSplitMergeClusters",
      "LAEC_ShSplitMergeClusterAssociations",
      "LAEC_PrShRawHits",
      "LAEC_PrShRecHits",
      "LAEC_PrShTruthClusters",
      "LAEC_PrShTruthClusterAssociations",
      "LAEC_PrShClusters",
      "LAEC_PrShClusterAssociations",

      "FAEC_ShRawHits",
      "FAEC_ShRecHits",
      "FAEC_ShTruthClusters",
      "FAEC_ShTruthClusterAssociations",
      "FAEC_ShClusters",
      "FAEC_ShClusterAssociations",
      "FAEC_ShSplitMergeClusters",
      "FAEC_ShSplitMergeClusterAssociations",
      "FAEC_PrShRawHits",
      "FAEC_PrShRecHits",
      "FAEC_PrShTruthClusters",
      "FAEC_PrShTruthClusterAssociations",
      "FAEC_PrShClusters",
      "FAEC_PrShClusterAssociations",
